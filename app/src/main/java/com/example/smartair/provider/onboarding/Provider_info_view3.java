...
public class Provider_info_view3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.provider_infoview3);

        right = findViewById(R.id.BottomRightButton);

        right.setOnClickListener(v -> {
            Intent intent = new Intent(this, Provider_info_view4.class);
